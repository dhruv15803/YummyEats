...
import { addMenuItem, deleteMenuItem, editMenuItem, editRestaurant, getFileUrl, getMenuItems, getMyRestaurants, getRestaurantById, getRestaurantsByCity, registerRestaurant, removeRestaurant } from '../controllers/restaurant.controller.js';
...
router.get('/getByCity/:cityName',getRestaurantsByCity)
